...
function starImages(rating)//the perpose of the function is to generate the HTML tags of several star imgages
{
      var imageText="";//empty string
...
{
      var reviewCode="";//empty text string
      if(reviewType[i]=="P")
      {
